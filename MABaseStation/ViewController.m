...
{
    CLLocationCoordinate2D coordinate = coordinateTemp;
    NSLog(@"coordianteTemp: %f %f cooedinate: %f %f",coordinateTemp.latitude,coordinateTemp.longitude,coordinate.latitude,coordinate.longitude);
    AMapReGeocodeSearchRequest *regeo = [[AMapReGeocodeSearchRequest alloc] init];
    
    regeo.location                    = [AMapGeoPoint locationWithLatitude:coordinate.latitude longitude:coordinate.longitude];
    
    NSLog(@"sssssssss latitude :%f longtitude :%f",regeo.location.latitude,regeo.location.longitude);
...
//    CLLocationCoordinate2D coordinateX = CLLocationCoordinate2DMake(39.907728, 116.397968);
...
//        [_mapView setCenterCoordinate:[annotations[0] coordinate] animated:YES];//可以在GeocodeAnnotation.m里设置坐标
        ...
        NSLog(@"gaungzhou %f %f ",[annotations[0] coordinate].latitude,[annotations[0] coordinate].longitude);
    }
    else
    {
...
//    NSLog(@"coordinateTemp %f %f",coordinateTemp.latitude,coordinateTemp.longitude);
